    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre', models.CharField(db_index=True, help_text='Escribir el nombre del grupo sanguíneo.', max_length=100, unique=True, validators=[django.core.validators.MinLengthValidator(1), django.core.validators.MaxLengthValidator(100)])),
                ('ultimo_usuario_editor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='grupos_sanguineos_gruposanguineo_related', to=settings.AUTH_USER_MODEL)),

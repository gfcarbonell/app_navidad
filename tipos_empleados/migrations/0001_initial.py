    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ultimo_usuario_editor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tipos_empleados_tipoempleado_related', to=settings.AUTH_USER_MODEL)),

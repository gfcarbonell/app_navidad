    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre', models.CharField(db_index=True, help_text='Escribir nombre del país.', max_length=100, unique=True)),
                ('codigo_postal', models.PositiveIntegerField(unique=True, verbose_name='Código postal')),
                ('imagen', models.ImageField(blank=True, default='default/No_Image_1.png', help_text='Subir imagen del país. (Opcional)', upload_to='imagenes_paises')),
